...
RUN apt-get install -y php7.0 php5.6 php5.6-mysql php5.6-gettext php5.6-mbstring php-xdebug libapache2-mod-php5.6 libapache2-mod-php7.0 apache2 apache2-utils mariadb-server  php5.6-xml php5.6-curl php5.6-mysql php5.6-mcrypt php5.6-intl php5.6-gmp php5.6-gd php5.6-json php5.6-imagick php-xml nodejs npm php-mysql screen php5.6-imap php-imap php-curl --allow-unauthenticated
