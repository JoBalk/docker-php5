...
RUN apt-get install -y php5.6-mysql php5.6-mcrypt php5.6-intl php5.6-gmp php5.6-gd php5.6-json php5.6-imagick php7.1-xml nodejs npm php7.1-mysql screen php5.6-imap php7.1-imap php7.1-curl --allow-unauthenticated
